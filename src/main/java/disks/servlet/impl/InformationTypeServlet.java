...
@WebServlet("/InformationType")
public class InformationTypeServlet extends GenericServlet {
    private static final GenericDao<InformationType> dao = MySqlDaoFactory.instance.
    ...
    protected void insert(HttpServletRequest request) throws PersistentException {
        var diskType = new InformationType();
